...
g++ -o "%APP_DIR%\Encryption_Algorithm_RGR.exe" src\main.cpp src\cipher_manager.cpp utils\file_utils.cpp "%APP_DIR%\dlls\atbash.dll" "%APP_DIR%\dlls\hill.dll" "%APP_DIR%\dlls\permutations.dll"
